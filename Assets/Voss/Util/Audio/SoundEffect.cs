...
namespace Voss.Util
{
    [CreateAssetMenu(menuName="Effect/Sound Effect")]
    public class SoundEffect : AudioEvent
    {
        ...
        public RangedFloat volume = new RangedFloat() {minimum = 0.9f, maximum = 1.0f};
        
        [MinMaxRange(0, 2)]
        public RangedFloat pitch = new RangedFloat() {minimum = 0.9f, maximum = 1.1f};
